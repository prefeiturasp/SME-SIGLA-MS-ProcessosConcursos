...
@patch('concursos.management.commands.criar_concursos_api.buscar_cargos_de_smeintegracao', autospec=True)
@patch('concursos.management.commands.criar_concursos_api.buscar_concursos_de_smeintegracao', autospec=True)
def test_criar_concursos_api_cria_registros(mock_buscar_concursos, mock_buscar_cargos):
    ...
    cargo_102 = Cargo.objects.get(codigo=102)
...
@patch('concursos.management.commands.criar_concursos_api.buscar_cargos_de_smeintegracao', autospec=True)
@patch('concursos.management.commands.criar_concursos_api.buscar_concursos_de_smeintegracao', autospec=True)
def test_criar_concursos_api_atualiza_existentes(mock_buscar_concursos, mock_buscar_cargos):
    ...
    concurso = Concurso.objects.create(nome='Antigo Concurso', numero_processo=1, codigo=1)
...
@patch('concursos.management.commands.criar_concursos_api.buscar_cargos_de_smeintegracao', autospec=True)
@patch('concursos.management.commands.criar_concursos_api.buscar_concursos_de_smeintegracao', autospec=True)
def test_criar_concursos_api_dry_run_nao_persiste(mock_buscar_concursos, mock_buscar_cargos):
    mock_buscar_cargos.return_value = _mock_cargos()
    mock_buscar_concursos.return_value = _mock_concursos()
...
@patch('concursos.management.commands.criar_concursos_api.buscar_cargos_de_smeintegracao', autospec=True)
@patch('concursos.management.commands.criar_concursos_api.buscar_concursos_de_smeintegracao', autospec=True)
def test_criar_concursos_api_quebra_api_nao_cria(mock_buscar_concursos, mock_buscar_cargos):
