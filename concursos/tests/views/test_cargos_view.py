...
def test_autorizacoes_publicadas_agrupa_e_integra_ms_escolhas(authenticated_client):
    """
    Testa a action /cargos/autorizacoes-publicadas/ agregando dados locais e integrando com ms-escolhas.
    """
    ...
    with patch('concursos.views.cargos.EscolhasAPIService.get_escolhas_por_cargo', return_value=DummyResp()):
